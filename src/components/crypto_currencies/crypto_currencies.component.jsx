...
import cryptoCurrenciesModule from './crypto_currencies.module.css';
...
export default () => {
  ...
  return (
      <div className={cryptoCurrenciesModule.cryptoCurrencies}>
        ...
        <p><strong>Bitcoin</strong> has emerged as the leading crypto currency in the market. Athough bitcoin was valued at less than $0.01 in May 2010, bitcoin value has risen to over $6,000 according to recent price data. Hence, crypto currencies may 
